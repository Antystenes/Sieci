...
/* package Sieci-0.1.0.0 */
#define VERSION_Sieci "0.1.0.0"
#define MIN_VERSION_Sieci(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package ad-4.3.2.1 */
#define VERSION_ad "4.3.2.1"
...
#define CURRENT_COMPONENT_ID "Sieci-0.1.0.0-2NPl0140VLwBZQcQ9LxbnM"

#define CURRENT_PACKAGE_KEY "Sieci-0.1.0.0-2NPl0140VLwBZQcQ9LxbnM"
